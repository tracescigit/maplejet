                    ...
                    <form method="GET" action="{{ route('products.index') }}">
                        <div data-label="Product List" class="df-example demo-table">
                            <div class="row row-sm  mg-b-10">
                                <div class="col-sm-3">
                                    <input type="text" name="batches_search" class="form-control" placeholder="Batch">
                                </div>
                                <div class="col-sm-3 mg-t-10 mg-sm-t-0">
                                    <input type="text" name="product_search" class="form-control" placeholder="Brand">
                                </div>
                                <div class="col-sm-3 mg-t-10  mg-sm-t-0">
                        ...
                        <table class="table table-striped mg-b-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{{$batch->currency}} - {{$batch->price}}</td>
