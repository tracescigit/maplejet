                                ...
                                <td class="text-center">
                                    <form id="statusform" method="POST">
                                        ...
                                        <div class="mx-auto" style="text-align: center;">
                                            ...
                                            <button class="btn btn-sm btn-success" type="button" onclick="changestatus('Inactive', {{$singledata->id}})" {{ empty($singledata->product->name) ? 'disabled' : '' }}>
                                                <i class="fas fa-thumbs-up"></i> Active
                                            </button>
                                            @else
                                            <button class="btn btn-sm btn-danger" type="button" onclick="changestatus('Active', {{$singledata->id}})" {{ empty($singledata->product->name) ? 'disabled' : '' }}>
