            ...
            <div class="container">
                <div class="d-flex bg-gray-10">
                    <div class="pd-10 flex-grow-1">
                        ...
                        <p class="mg-b-30">Use this page to <code style="color:#e300be;">Edit</code> Jobs Details.</p>
                        <hr>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="job_code" id="job_code" class="form-control" value="{{$productionjob->code}}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
